...
import { violationCategoriesCount1 } from '../../../dummyData/chart';
...
const ViolationCategoriesCount = () => {
  ...
  useEffect(() => {
    if (violationCategoriesCount1?.info) {
      const data = violationCategoriesCount1.info;
